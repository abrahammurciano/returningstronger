			...
			<div class='sign-up-section'>
				...
				<div class="description">
					<span class="highlight">
						...
						Let's commit for the next 30 days switch our mobile phones off, or onto flight mode before entering the Bet Hakeneset and to not converse inside the synagogue.
					</span>
				</div>
